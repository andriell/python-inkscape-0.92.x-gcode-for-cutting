...
class laser_gcode(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("", "--power-off-delay", action="store", type="int", dest="power_off_delay",
        ...
        self.OptionParser.add_option("", "--set-home-first", action="store", type="inkbool", dest="set_home_first",
                                     default=True, help="Set the home position first")
        self.OptionParser.add_option("", "--height", action="store", type="string", dest="height", default="50",
                                     help="Height")
    ...
    def check_dir(self):
        ...
        if (os.path.isdir(self.options.directory)):
            ...
            if self.options.set_home_first:
                self.header += "G28 X0 Y0\n"
                self.header += "G4 P100\n"
                self.header += "G28 Z0\n"
                self.header += "G4 P100\n"

            if float(self.options.height) > 0:
                self.header += "G1 Z%.3f\n" % float(self.options.height)
                self.header += "G4 P100\n"
        else:

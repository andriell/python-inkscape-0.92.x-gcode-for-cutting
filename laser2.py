...
class laser_gcode(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("",   "--set-home-first",                  action="store", type="inkbool",         dest="set_home_first",                      default=True,                           help="Set the home position first")
        self.OptionParser.add_option("",   "--height",                          action="store", type="string",          dest="height",                              default="50",                           help="Height")
